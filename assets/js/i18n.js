...
const I18N = {
  zh: {
    ...
    "toolsIndex.meta.description": "轻量工具与项目入口 · AI Digest by Syneira Lab",
    "toolsIndex.kicker": "TOOLS · 工具",
    "toolsIndex.title": "从真实场景里长出来的工具和小项目",
    "toolsIndex.lead": "这里不是产品展柜，而是一张正在长大的工作台：社区协作、家庭看板、文化互动、纪念空间，以及一些可以随手打开用的轻量工具。",
  ...
  en: {
    ...
    "tools.text": "Community, family, and culture projects in one shelf.",
    "tools.all": "All Tools →",
    ...
    "toolsIndex.meta.description": "A collection of lightweight tools and live project entry points from AI Digest by Syneira Lab.",
    "toolsIndex.kicker": "TOOLS",
    "toolsIndex.title": "Tools and Small Projects Grown From Real Use",
    "toolsIndex.lead": "This is less a product showroom than a working shelf: community coordination, family dashboards, culture games, memorial spaces, and lightweight tools you can open when needed.",
    "toolsIndex.featured.kicker": "LIVE PROJECTS",
