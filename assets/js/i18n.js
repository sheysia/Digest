...
const I18N = {
  zh: {
    ...
    "feedback.back": "← 返回首页",
    "connect.meta.title": "职场互助 · DMVoice Community",
    "connect.meta.description": "DMVoice 社群职场互助板：内推资源、技能交换、求职需求，低门槛登记与浏览。",
    "connect.eyebrow": "DMVOICE COMMUNITY",
    "connect.title": "职场<em>互助</em>",
    "connect.lead": "你找人，或被人找到。内推资源、技能交换、求职需求，一个低门槛的社群互助板。",
    "connect.leadEn": "内推、技能、求职 — 来自 DMVoice 社群的职场互助。",
    "connect.submit": "我要登记",
    "connect.tabOffer": "我能帮",
    "connect.tabSeek": "我想找",
    "connect.loading": "加载中...",
    "connect.empty": "暂无条目",
    "connect.noData": "互助板即将上线，敬请期待",
    "connect.loadError": "数据加载失败，请稍后刷新",
    "connect.expTitle": "经验帖",
    "connect.expSub": "面经、谈薪、转行心得 — 来自社群成员的真实分享",
    "connect.exp1.meta": "2026 Q2 / 匿名群友",
    "connect.exp1.title": "联邦政府转 contractor 的几个注意点",
    "connect.exp1.text": "从 GS 岗位转 contractor 不是降级，关键看 clearance 能不能带走，以及对方给的 PTO 和 benefits 怎么谈。群里聊过几次，这里整理下重点。",
    "connect.exp2.meta": "2026 Q2 / 匿名群友",
    "connect.exp2.title": "非 CS 背景转 data analyst 的路径复盘",
    "connect.exp2.text": "政治学本科 + 公共政策硕士，花了大概一年半转到 data analyst。SQL 和 Tableau 是核心，Python 是加分项，面试准备方法分享。",
    "connect.notice": "信息由管理员审核后展示，定期维护。需要修改或下架，请<a href=\"/feedback.html\">联系管理员</a>。",
    "connect.aboutToggle": "关于此页: 怎么用, 怎么建的",
    "connect.aboutHow": "怎么用",
    "connect.aboutHow1": "浏览: 打开此页, 切换「我能帮」/「我想找」两个 tab。不需要登录。",
    "connect.aboutHow2": "登记: 点「我要登记」按钮, 跳转 Google Form 填写。审核通过后会出现在板上。",
    "connect.aboutHow3": "修改/下架: 联系管理员处理, 没有自助编辑功能。",
    "connect.aboutPrivacy": "隐私与安全",
    "connect.aboutPrivacy1": "所有提交先进入私有表格, 管理员审核后才展示。原始数据不对外暴露。",
    "connect.aboutPrivacy2": "联系方式选填, 建议填群内昵称/微信名/可公开邮箱, 不建议手机号。",
    "connect.aboutPrivacy3": "提交时需勾选「我确认以上内容可公开展示」。",
    "connect.aboutTech": "技术实现",
    "connect.aboutTechText": "整套方案零后端、零数据库、零登录。群友通过 Google Form 提交, 数据进入 Google Sheet, 管理员审核后复制到公开 tab, 页面自动拉取并渲染为卡片。托管在 GitHub Pages, 运行成本为零。",
    "connect.aboutFaq": "常见问题",
    "connect.aboutFaq1": "填了没看到? 需要审核, 通常 1-2 天。",
    "connect.aboutFaq2": "信息过期? 联系管理员下架, 管理员也会定期清理。",
    "connect.aboutFaq3": "为什么不做登录? 门槛越低越多人用, 让流动先发生。",
    "connect.byline": "DMVoice AI Group, supported by Syneira Lab",
    "connect.back": "← 返回首页",
  ...
  en: {
    ...
    "connect.meta.title": "Career Connect · DMVoice Community",
    "connect.meta.description": "Referrals, skill exchange, and job search support from the DMVoice community.",
    "connect.eyebrow": "DMVOICE COMMUNITY",
    "connect.title": "Career <em>Connect</em>",
    "connect.lead": "Referrals, skill exchange, and job search support from the DMVoice community.",
    "connect.leadEn": "A low-barrier community board for career help within DMVoice.",
    "connect.submit": "Submit a listing",
    "connect.tabOffer": "I can help",
    "connect.tabSeek": "I'm looking for",
    "connect.loading": "Loading...",
    "connect.empty": "No listings yet",
    "connect.noData": "Board coming soon, stay tuned",
    "connect.loadError": "Failed to load data, please refresh later",
    "connect.expTitle": "Experience Posts",
    "connect.expSub": "Interview tips, negotiation stories, and career-change journeys shared by community members",
    "connect.exp1.meta": "2026 Q2 / Community member",
    "connect.exp1.title": "Tips for transitioning from federal GS to contractor roles",
    "connect.exp1.text": "Moving from a GS position to contracting isn't a downgrade. Key considerations: whether your clearance transfers and how to negotiate PTO and benefits.",
    "connect.exp2.meta": "2026 Q2 / Community member",
    "connect.exp2.title": "Career switch to data analyst from a non-CS background",
    "connect.exp2.text": "Poli-sci undergrad + public policy master's, took about 18 months to land a data analyst role. SQL and Tableau were core, Python was a bonus.",
    "connect.notice": "All listings are reviewed by an admin before display. To update or remove a listing, please <a href=\"/feedback.html\">contact the admin</a>.",
    "connect.aboutToggle": "About this page: how it works",
    "connect.aboutHow": "How to use",
    "connect.aboutHow1": "Browse: open this page and switch between the \"I can help\" / \"I'm looking for\" tabs. No login needed.",
    "connect.aboutHow2": "Submit: click \"Submit a listing\" to fill out a Google Form. Your entry appears after admin review.",
    "connect.aboutHow3": "Edit/Remove: contact the admin. There is no self-service editing.",
    "connect.aboutPrivacy": "Privacy & safety",
    "connect.aboutPrivacy1": "All submissions go to a private sheet first. Only admin-approved entries are displayed publicly.",
    "connect.aboutPrivacy2": "Contact info is optional. Use your group nickname, WeChat name, or a public email. Avoid phone numbers.",
    "connect.aboutPrivacy3": "You must check \"I confirm this information can be displayed publicly\" before submitting.",
    "connect.aboutTech": "How it's built",
    "connect.aboutTechText": "Zero backend, zero database, zero login. Submissions go through Google Form into Google Sheets. An admin reviews and copies approved entries to a public tab. This page fetches and renders them as cards. Hosted on GitHub Pages at zero cost.",
    "connect.aboutFaq": "FAQ",
    "connect.aboutFaq1": "Submitted but don't see it? It needs admin review, usually 1-2 days.",
    "connect.aboutFaq2": "Info outdated? Contact the admin to remove it. Periodic cleanup is also done.",
    "connect.aboutFaq3": "Why no login? Lower barrier = more participation. Let the flow happen first.",
    "connect.byline": "DMVoice AI Group, supported by Syneira Lab",
    "connect.back": "← Back to home",
...
if (forcedByQuery) localStorage.setItem('syneira-digest-lang', queryLang);
